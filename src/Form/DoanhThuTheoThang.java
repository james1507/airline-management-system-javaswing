 ...
 * @author conne
 */
public class DoanhThuTheoThang extends javax.swing.JFrame {
    
    /**
     * Creates new form DoanhThuTheoThang
     */
    ...
    private void initComponents() {
        ...
        txtNam.setForeground(new java.awt.Color(0, 153, 153));
        ...
        btnNam.setForeground(new java.awt.Color(0, 153, 153));
        ...
        jPanel5.add(lblTongSoGhe, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 610, -1, -1));
        ...
        txtQuy.setForeground(new java.awt.Color(0, 153, 153));
        ...
        jPanel5.add(lblTongTien, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 610, -1, -1));
        ...
        txtThuongGia_KhuHoi.setForeground(new java.awt.Color(0, 153, 153));
        ...
        txtThuongGia_MotChieu.setForeground(new java.awt.Color(0, 153, 153));
        ...
        txtPhoThong_KhuHoi.setForeground(new java.awt.Color(0, 153, 153));
        ...
        txtPhoThong_MotChieu.setForeground(new java.awt.Color(0, 153, 153));
        ...
        tblDoanhThuThang.setForeground(new java.awt.Color(0, 153, 153));
        tblDoanhThuThang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Hóa Đơn", "Ngày Vé", "Giá Bán (Triệu)", "Số ghế đặt", "Thành tiền (Triệu)"
            }
        ) {
        ...
        jPanel5.add(splTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 330, 640, 250));
        ...
        jPanel5.add(btnTroVe, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 590, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoanhThuTheoThang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
