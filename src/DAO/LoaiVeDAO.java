 ...
 * @author conne
 */
public class LoaiVeDAO extends ConnectSQL {
    ...
    public LoaiVemdl timLVToDen(String cmnd) {
        try {
            ...
            if (rs.next()) {
                LoaiVemdl lv = new LoaiVemdl(rs.getString(1));
                return lv;
            }
        } catch (Exception e) {
            //e.printStackTrace();
