 ...
 * @author conne
 */
public class HangVeDAO extends Connection.ConnectSQL {
    ...
    public HangVemdl timHVToDen(String cmnd) {
        try {
            ...
            if (rs.next()) {
                HangVemdl lv = new HangVemdl(rs.getString(1));
                return lv;
            }
        } catch (Exception e) {
            //e.printStackTrace();
