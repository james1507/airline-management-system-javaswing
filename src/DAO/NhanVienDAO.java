 ...
 * @author conne
 */
public class NhanVienDAO extends Connection.ConnectSQL {
    ...
    public int them(NhanVienmdl nv) {
        try {
    ...
    public void hienThi(JTable tbl, NhanVienmdl nv, int q) {
    ...
    public NhanVienmdl timNVToDen(String ma) {
        try {
            ...
            if (rs.next()) {
                NhanVienmdl sb = new NhanVienmdl(rs.getString(1));
                return sb;
            }
        } catch (Exception e) {
            //e.printStackTrace();
