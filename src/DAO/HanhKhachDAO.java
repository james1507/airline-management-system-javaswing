 ...
 * @author conne
 */
public class HanhKhachDAO extends Connection.ConnectSQL {
    public ArrayList<HanhKhachmdl> abc(){
        try {
            ...
            while(rs.next()){
                HanhKhachmdl hk = new HanhKhachmdl(rs.getString(1), rs.getString(2), rs.getBoolean(3), rs.getString(4), rs.getString(5), rs.getString(6));
                arr.add(hk);
            }
            return arr;
        } catch (Exception e) {
    ...
    public int them(HanhKhachmdl hk) {
        try {
    ...
    public int sua(HanhKhachmdl hk) {
        try {
    ...
    public int xoa(HanhKhachmdl hk) {
        try {
    ...
    public void hienThi(JTable tbl, HanhKhachmdl hk, int q){
    ...
    public HanhKhachmdl timHKToDen(String ma) {
        try {
            ...
            if (rs.next()) {
                HanhKhachmdl hk = new HanhKhachmdl(rs.getString(1));
                return hk;
            }
        } catch (Exception e) {
            //e.printStackTrace();
