 ...
 * @author conne
 */
public class SanBayDAO extends ConnectSQL {
    ...
    public void hienThi(JTable tbl, SanBaymdl sb, int q) {
    ...
    public SanBaymdl timSBToDen(String ma) {
        try {
            ...
            if (rs.next()) {
                SanBaymdl sb = new SanBaymdl(rs.getString(1));
                return sb;
            }
        } catch (Exception e) {
            //e.printStackTrace();
