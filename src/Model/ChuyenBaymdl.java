...
public class ChuyenBaymdl {
    ...
    public ChuyenBaymdl(String maChuyenBay) {
        this.maChuyenBay = maChuyenBay;
    }

    public ChuyenBaymdl(String maChuyenBay, String ngayDi, String ngayDen, String gioKhoiHanh, int soGheThuongGia, int soGhePhoThong, String maTuyenBay, String mamayBay) {
        this.maChuyenBay = maChuyenBay;
        this.ngayDi = ngayDi;
